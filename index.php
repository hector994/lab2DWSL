...
function getLastFourValues($array) {
    $lastValue = null;
    $secondLastValue = null;
    $thirdLastValue = null;
    $fourthLastValue = null;
    
    foreach ($array as $value) {
        $fourthLastValue = $thirdLastValue;
        $thirdLastValue = $secondLastValue;
        $secondLastValue = $lastValue;
        $lastValue = $value;
    }
    
    $result = array_filter([$fourthLastValue, $thirdLastValue, $secondLastValue, $lastValue]);

    return $result;
}
$result = getLastFourValues($data);
...
function getLastFourValuesinte($internacionales) {
    $lastValue = null;
    $secondLastValue = null;
    $thirdLastValue = null;
    $fourthLastValue = null;
    
    foreach ($internacionales as $value) {
        $fourthLastValue = $thirdLastValue;
        $thirdLastValue = $secondLastValue;
        $secondLastValue = $lastValue;
        $lastValue = $value;
...
$resultinter = getLastFourValuesinte($internacionales);
...
function getLastFourValuesdepor($deportes) {
    $lastValue = null;
    $secondLastValue = null;
    $thirdLastValue = null;
    $fourthLastValue = null;
...
$resultdepo = getLastFourValuesdepor($deportes);
    ...
    <body>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="admin/nacionales/nacionales.php">NACIONALES</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin/internacionales/internacionales.php">INTERNACIONALES</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin/deportes/deportes.php">DEPORTE</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">NOTICIAS DE EL SALVADOR Y EL MUNDO</h1>
        ...
        <section class="py-5"> 
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <?php  foreach($result as $medicamento ):  ?> 
                    <div class="col mb-5"> 
          ...
          <section class="py-5"> 
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <?php  foreach ($resultinter as $medicamento) : ?> 
                    <div class="col mb-5"> 
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="medicamento-imagen" src="imgServer/img/<?php echo $medicamento->imagen; ?>" alt="<?php echo $medicamento->titulo; ?>">
          ...
          <section class="py-5"> 
            <div class="container px-4 px-lg-5 mt-5">
                <h3>DEPORTE</h3>
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <?php  foreach ($resultdepo as $medicamento) : ?> 
                    <div class="col mb-5"> 
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="medicamento-imagen" src="imgServer/img/<?php echo $medicamento->imagen; ?>" alt="<?php echo $medicamento->titulo; ?>">
